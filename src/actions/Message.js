...
export const loadSections = () => {
  return dispatch => {
    ...
    getSectionsDB()
      ...
      .catch(error => {
        dispatch({ type: actionType.LOAD_SECTIONS_FAILED, payload: error });
      });
  };
};
  ...
  return dispatch => {
    ...
    addSection(name)
      .then(res => {
        ...
        dispatch({ type: actionType.ADD_SECTION_SUCCESS });
      })
      .catch(error => {
        dispatch({ type: actionType.ADD_SECTION_FAILED, payload: error });
      });
  };
};
